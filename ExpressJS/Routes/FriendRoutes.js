...
router.get('/get_all_from_friends_list', FriendController.GetAllFromFriendsList)
router.delete('/end_a_friendship', FriendController.EndAFriendship)

router.get('/get_all_from_friend_invitations_list', FriendController.GetAllFromFriendInvitationsList)
